...
class ProjectsController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'project_status'        => 'required|in:off_plan,ready,under_construction,handover',
            'sales_status'          => 'required|in:available,sold_out,coming_soon,handover',
            'project_code'          => 'nullable|string|max:255|unique:projects,project_code',
            'price_status'          => 'required|in:price,on_request,coming_soon,sold_out,handover',
